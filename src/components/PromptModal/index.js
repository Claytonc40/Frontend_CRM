              ...
              <DialogContent dividers className={classes.dialogContent}>
                <Paper className={classes.infoPanel} elevation={0}>
                  <Typography variant="body2">
                    <span className={classes.infoIcon}>ℹ️</span> Os prompts
                    permitem que você configure como a IA do OpenAI irá
                    interagir em suas conversas. Defina as instruções de
                    comportamento, tom de voz e conhecimentos específicos para
                    seu atendimento.
                  </Typography>
                </Paper>
                ...
                <div className={classes.formSection}>
                  ...
                  <Typography className={classes.helpText}>
                    Seja detalhado nas instruções para obter melhores resultados
                    da IA
                  </Typography>
                      ...
                      <>
                        ...
                        <Grid item xs={12} md={6}>
                          <Field
                            ...
                            helperText={
                              touched.voiceRegion && errors.voiceRegion
                            }
                            variant="outlined"
                            margin="dense"
                            fullWidth
                ...
                <div className={classes.formSection}>
                  ...
                  <Grid container spacing={2}>
                    <Grid item xs={12} md={4}>
                      ...
                      />
                      <Typography className={classes.helpText}>
                        Valores mais altos (ex: 1) geram respostas mais
                        criativas
                      </Typography>
                    </Grid>
                    <Grid item xs={12} md={4}>
