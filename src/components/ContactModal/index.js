						...
						<Form>
							<DialogContent className={classes.dialogContent} dividers>
								...
								<Grid container spacing={2} className={classes.formGrid}>
									...
									<Grid item xs={12} sm={6} style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
										<div className={classes.phoneInputContainer}>
											...
											{touched.number && errors.number && (
												<div className={classes.phoneErrorHelper}>{errors.number}</div>
											)}
										</div>
									</Grid>
									<Grid item xs={12}>
								...
								{contact?.whatsapp && (
									<div className={classes.infoSection}>
										...
										<Box border={1} borderColor="rgba(0, 0, 0, 0.1)" borderRadius={10} p={2} bgcolor="rgba(0, 0, 0, 0.02)">
								...
								<div className={classes.infoSection}>
									<Typography variant="subtitle1" className={classes.sectionTitle}>
										{i18n.t("contactModal.form.extraInfo") || "Informações adicionais"}
									</Typography>
											...
											<>
												{values.extraInfo && values.extraInfo.length > 0 ? (
															...
															<Grid container spacing={2}>
																<Grid item xs={5}>
																	<div className={classes.infoFieldContainer}>
																		<Typography className={classes.infoFieldTitle}>
																			{i18n.t("contactModal.form.extraName") || "Campo"}
																		</Typography>
																		<Field
																			as={TextField}
																...
																<Grid item xs={6}>
																	<div className={classes.infoFieldContainer}>
																		<Typography className={classes.infoFieldTitle}>
																			{i18n.t("contactModal.form.extraValue") || "Valor"}
																		</Typography>
																		<Field
																			as={TextField}
													...
													<Typography className={classes.emptyInfoText}>
														Nenhuma informação adicional. Clique no botão abaixo para adicionar.
													</Typography>
												)}
												<div style={{ textAlign: "center", marginTop: 16 }}>
													...
													>
														{i18n.t("contactModal.buttons.addExtraInfo") || "+ Adicionar informação"}
													</Button>
												</div>
											</>
										)}
