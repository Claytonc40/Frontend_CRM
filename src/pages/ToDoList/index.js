...
const getCategories = (i18n) => [
  ...
  {
    id: "clients",
    label: i18n.t("toDoList.categories.clients"),
    color: "#5D3FD3",
  },
  {
    id: "meetings",
    label: i18n.t("toDoList.categories.meetings"),
    color: "#FF5733",
  },
  {
    id: "followup",
    label: i18n.t("toDoList.categories.followup"),
    color: "#1E88E5",
  },
  { id: "sales", label: i18n.t("toDoList.categories.sales"), color: "#FFC107" },
  {
    id: "support",
    label: i18n.t("toDoList.categories.support"),
    color: "#607D8B",
  },
];
...
const ToDoList = () => {
  ...
  const handleAddTask = () => {
    ...
    if (editIndex >= 0) {
      ...
      newTasks[editIndex] = {
        ...
        updatedAt: now,
        category:
          selectedCategory || newTasks[editIndex].category || categories[5].id,
      };
      setTasks(newTasks);
      setTask("");
      setEditIndex(-1);
  ...
  const formatDate = (date) => {
    ...
    if (taskDate.toDateString() === now.toDateString()) {
      return `${i18n.t("toDoList.today")}, ${taskDate.toLocaleTimeString([], {
        hour: "2-digit",
        minute: "2-digit",
      })}`;
    }
    ...
    if (taskDate.toDateString() === yesterday.toDateString()) {
      return `${i18n.t("toDoList.yesterday")}, ${taskDate.toLocaleTimeString(
        [],
  ...
  const getCategoryInfo = (categoryId) => {
    const category =
      categories.find((cat) => cat.id === categoryId) || categories[5];
    return {
                ...
                >
                  <ListItem
                    className={`${classes.taskItem} ${
                      task.completed ? classes.taskItemCompleted : ""
                    }`}
                    button
                  >
                    <ListItemIcon
                      onClick={() => handleToggleComplete(tasks.indexOf(task))}
                    >
                      <Checkbox
                        edge="start"
                      ...
                      secondary={
                        <div>
                          <Chip
                            ...
                            style={{
                              backgroundColor:
                                getCategoryInfo(task.category).color + "20",
                              color: getCategoryInfo(task.category).color,
                              borderColor:
                                getCategoryInfo(task.category).color + "40",
                              borderWidth: 1,
                              borderStyle: "solid",
                            }}
                          />
