/*! For license information please see 3.687797b4.chunk.js.LICENSE.txt */
        ...
        !(function () {
          ...
          a.prototype = {
              ...
              if (!(d >= p)) {
                ...
                if (n._webAudio) {
                  var m = function () {
                    ...
                    h.gain.setValueAtTime(e, i.ctx.currentTime),
                      (s._playStart = i.ctx.currentTime),
                      "undefined" === typeof h.bufferSource.start
                        ? s._loop
                          ? h.bufferSource.noteGrainOn(0, d, 86400)
                          : h.bufferSource.noteGrainOn(0, d, _)
                        : s._loop
                          ? h.bufferSource.start(0, d, 86400)
                          : h.bufferSource.start(0, d, _),
                      l !== 1 / 0 &&
                  ...
                  var y = function () {
                    (h.currentTime = d),
                      (h.muted = s._muted || n._muted || i._muted || h.muted),
                      (h.volume = s._volume * i.volume()),
                    ...
                    try {
                      ...
                      if (
                        ...
                        (o instanceof Promise || "function" === typeof o.then)
                          ...
                          : t ||
                            ((n._playLock = !1), f(), n._emit("play", s._id)),
                        (h.playbackRate = s._rate),
                        h.paused)
                      )
                        return void n._emit(
                  ...
                  "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA" ===
                    h.src && ((h.src = n._src), h.load());
                  var v =
                    (window && window.ejecta) ||
                    (!h.readyState && i._navigator.isCocoonJS);
                  if (h.readyState >= 3 || v) y();
                    ...
                    var A = function () {
                      (n._state = "loaded"),
                        y(),
                        h.removeEventListener(i._canPlayEvent, A, !1);
                    };
                    h.addEventListener(i._canPlayEvent, A, !1),
                      n._clearTimer(s._id);
                  }
                }
                return s._id;
            ...
            volume: function () {
              ...
              if (
                1 === r.length ||
                (2 === r.length && "undefined" === typeof r[1])
              ) {
            ...
            rate: function () {
              ...
              "undefined" === typeof t && (o._rate = e),
                (t = o._getSoundIds(t));
              for (var u = 0; u < t.length; u++)
                if ((n = o._soundById(t[u]))) {
                  o.playing(t[u]) &&
                    ((n._rateSeek = o.seek(t[u])),
                  ...
                  var d = o.seek(t[u]),
                    _ =
                      (o._sprite[n._sprite][0] + o._sprite[n._sprite][1]) /
                        1e3 -
                      d,
                    l = (1e3 * _) / Math.abs(n._rate);
                  (!o._endTimers[t[u]] && n._paused) ||
                    (o._clearTimer(t[u]),
                    (o._endTimers[t[u]] = setTimeout(o._ended.bind(o, n), l))),
                    o._emit("rate", n._id);
                }
              return o;
            },
              ...
              if (s) {
                if (!("number" === typeof e && e >= 0)) {
                  if (n._webAudio) {
                    ...
                    return s._seek + (d + u * Math.abs(s._rate));
                  }
          ...
          var u = {},
            d = function (e) {
              var t = e._src;
              if (u[t]) return (e._duration = u[t].duration), void c(e);
            ...
            l = function (e, t) {
              var n = function () {
                ...
                o = function (e) {
                  e && t._sounds.length > 0 ? ((u[t._src] = e), c(t, e)) : n();
                };
              "undefined" !== typeof Promise &&
...
//# sourceMappingURL=3.687797b4.chunk.js.map
